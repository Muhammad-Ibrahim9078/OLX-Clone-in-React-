...
function PropertiesCardsSlider() {
  ...
  useEffect(() => {
    async function fetchData() {
      try {
        const q = query(collection(db, "products"), where("category", "==", "property"));
  ...
  // SweetAlert function to show product details
  const showDetails = (card) => {
    Swal.fire({
      ...
      html: `
        ...
        <p><b>Mobile:</b> ${card.contact || "Not available"}</p>
...
export default PropertiesCardsSlider;
